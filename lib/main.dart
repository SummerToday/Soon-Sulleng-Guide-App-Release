    ...
    try {
      ...
      if (accessToken != null) {
        ...
        final response = await http.post(
          Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/check-login-status'),
          headers: {
  ...
  Future<void> _refreshAccessToken() async {
    try {
      ...
      if (refreshToken != null) {
        ...
        final response = await http.post(
          Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/refresh-token'),
          headers: {
            'Content-Type': 'application/json',
          },
