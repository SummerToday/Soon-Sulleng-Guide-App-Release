  ...
  Future<void> _fetchSearchResults() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/search/list?keyword=${widget.searchKeyword}'),
        headers: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          '검색 결과',
          style: TextStyle(fontFamily: 'Yangjin', color: Colors.white, fontSize: 22),
        ),
