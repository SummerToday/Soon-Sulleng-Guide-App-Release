...
class _WriteReviewState extends State<WriteReview> {
  ...
  Future<void> _submitReview(BuildContext context) async {
    ...
    if (_storeName.isEmpty ||
        _reviewTitle.isEmpty ||
        _menuName.isEmpty ||
        _reviewContent.isEmpty ||
        _price.isEmpty ||
        _selectedStars == 0) {
      showDialog(
        context: context,
    ...
    var uri = Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/reviews');
