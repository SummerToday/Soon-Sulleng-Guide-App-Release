...
class _LobyState extends State<Loby> {
  ...
  Future<void> _fetchReviewData() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/reviews/getReviews'),
        headers: {
  ...
  Future<void> _fetchFavoriteList() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/favorites/list'),
        headers: {
          'Authorization': 'Bearer $accessToken',
  ...
  Future<void> _fetchFavoriteStatus() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/favorites/status'),
        headers: {
          'Authorization': 'Bearer $accessToken',
          'Content-Type': 'application/json',
        },
  ...
  void _toggleFavorite(int itemId, bool isFavorite) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/favorites$endpoint'),
        headers: {
          'Authorization': 'Bearer $accessToken',
          'Content-Type': 'application/json',
        },
  ...
  Future<void> _fetchAllReviews() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/reviews/allReviews'),
        headers: {
          'Authorization': 'Bearer $accessToken',
          'Content-Type': 'application/json; charset=utf-8',
        },
...
class _LobyPageState extends State<LobyPage> {
  ...
  Future<void> _performSearch(String keyword) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/search/list?keyword=$keyword'),
        headers: {
          'Authorization': 'Bearer $accessToken',
          'Content-Type': 'application/json',
        },
  ...
  Future<void> _fetchReviewDetail(int itemId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/reviews/$itemId'),
        headers: {
          'Authorization': 'Bearer $accessToken',
          'Content-Type': 'application/json',
        },
