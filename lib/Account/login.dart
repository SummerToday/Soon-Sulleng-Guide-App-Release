...
class _LoginWidgetState extends State<LoginWidget>
  ...
  GoogleSignIn _googleSignIn = GoogleSignIn(
    serverClientId: 'client-id',  // 웹 클라이언트 ID
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        final response = await http.post(
          Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/google-login'),
        ...
        if (response.statusCode == 200) {
          ...
          final checkNickResponse = await http.get(
            Uri.parse('http://Soon-Sulleng-Guide-1365335815.ap-northeast-2.elb.amazonaws.com/api/users/check-nickname?email=$email'),
            headers: {
